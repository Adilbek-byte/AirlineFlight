...
public class AirFlights
{
        ...
        List<Flight> Flights = new List<Flight>()
    {
        ...
        new Flight(8, "FlyEthihad", Flight.IsGearedUp(), FlightClass.SetRandomClass(), new LocationPath { FromWhere = "Astana", ToWhere = "Bishkek" }, new FlightSchedule(), new TypeOfPrices(), new Passenger(), new WeatherForecast(), new Bonus()),
        new Flight(9, "Aeroflot", Flight.IsGearedUp(), FlightClass.SetRandomClass(), new LocationPath { FromWhere = "Moscow", ToWhere = "Osh" }, new FlightSchedule(), new TypeOfPrices(), new Passenger(), new WeatherForecast(), new Bonus()),
        new Flight(10, "Air Kyrgyzstan", Flight.IsGearedUp(), FlightClass.SetRandomClass(), new LocationPath { FromWhere = "Jalal-Abad", ToWhere = "Bishkek" }, new FlightSchedule(), new TypeOfPrices(), new Passenger(), new WeatherForecast(), new Bonus()),
        new Flight(11, "Air Kyrgyzstan", Flight.IsGearedUp(), FlightClass.SetRandomClass(), new LocationPath { FromWhere = "Tamchy", ToWhere = "London" }, new FlightSchedule(), new TypeOfPrices(), new Passenger(), new WeatherForecast(), new Bonus()),
        };
        return Flights;
